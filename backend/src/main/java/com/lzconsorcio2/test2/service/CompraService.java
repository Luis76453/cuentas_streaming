...
public class CompraService {
    ...
    public CompraService(CompraRepository compraRepository,  DetalleCompraService detalleCompraService, DetalleCompraRepository detalleCompraRepository) {
    ...
    public Map<String, Object> getPurchaseStatistics() {
        ...
        // Cuentas vendidas (suma de quantities)
        ...
        // Cálculo de % de cambio (lógica simplificada, podrías hacerla más compleja)
